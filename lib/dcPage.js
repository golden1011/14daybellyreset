...
const beforeAfterProofSection = `
      <div style="max-width: 1120px; margin: 34px auto 0; display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 14px; text-align: left;">
        <div style="background: #14120f; border: 1px solid rgba(240,83,28,0.24); border-radius: 12px; overflow: hidden; box-shadow: 0 18px 42px rgba(0,0,0,0.32);">
          ...
          <div style="padding: 15px 16px 17px;">
            <div style="font-family: 'Barlow Condensed', sans-serif; font-weight: 700; letter-spacing: 1.2px; color: #FF7A3D; font-size: 13px;">REAL-LIFE SETTING</div>
            <div style="font-size: 15.5px; line-height: 1.45; color: rgba(244,240,232,0.74); margin-top: 5px;">Not studio perfect. A normal hallway, normal clothes, and the waist as the scoreboard.</div>
          </div>
        </div>
        <div style="background: #14120f; border: 1px solid rgba(240,83,28,0.24); border-radius: 12px; overflow: hidden; box-shadow: 0 18px 42px rgba(0,0,0,0.32);">
          ...
          <div style="padding: 15px 16px 17px;">
            <div style="font-family: 'Barlow Condensed', sans-serif; font-weight: 700; letter-spacing: 1.2px; color: #FF7A3D; font-size: 13px;">DIFFERENT BODY TYPES</div>
            <div style="font-size: 15.5px; line-height: 1.45; color: rgba(244,240,232,0.74); margin-top: 5px;">The plan is built for grown men, not one polished fitness-model look.</div>
          </div>
        </div>
        <div style="background: #14120f; border: 1px solid rgba(240,83,28,0.24); border-radius: 12px; overflow: hidden; box-shadow: 0 18px 42px rgba(0,0,0,0.32);">
          ...
          <div style="padding: 15px 16px 17px;">
            <div style="font-family: 'Barlow Condensed', sans-serif; font-weight: 700; letter-spacing: 1.2px; color: #FF7A3D; font-size: 13px;">NOT OVER-POLISHED</div>
            <div style="font-size: 15.5px; line-height: 1.45; color: rgba(244,240,232,0.74); margin-top: 5px;">Workshop lighting, casual clothes, and a realistic change you can believe.</div>
          </div>
        </div>
        <div style="background: #14120f; border: 1px solid rgba(240,83,28,0.24); border-radius: 12px; overflow: hidden; box-shadow: 0 18px 42px rgba(0,0,0,0.32);">
          ...
          <div style="padding: 15px 16px 17px;">
            <div style="font-family: 'Barlow Condensed', sans-serif; font-weight: 700; letter-spacing: 1.2px; color: #FF7A3D; font-size: 13px;">NORMAL LIFE</div>
            <div style="font-size: 15.5px; line-height: 1.45; color: rgba(244,240,232,0.74); margin-top: 5px;">Backyard, work clothes, no gym mirror. Just a smaller waist and a clearer plan.</div>
          </div>
        </div>
      </div>
      <style>
