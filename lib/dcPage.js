...
const beforeAfterProofSection = `
      <div style="max-width: 980px; margin: 34px auto 0; display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 16px; text-align: left;">
        ...
        <div style="background: #14120f; border: 1px solid rgba(240,83,28,0.24); border-radius: 12px; overflow: hidden; box-shadow: 0 18px 42px rgba(0,0,0,0.32);">
          <img src="/uploads/1_NNJ8ujTGMBAle2XcMS4ThA.png" alt="Visceral fat before and after illustration" style="display: block; width: 100%; aspect-ratio: 16 / 9; object-fit: cover; object-position: center;">
          <div style="padding: 15px 16px 17px;">
        ...
        <div style="background: #14120f; border: 1px solid rgba(240,83,28,0.24); border-radius: 12px; overflow: hidden; box-shadow: 0 18px 42px rgba(0,0,0,0.32);">
          <img src="/uploads/maxresdefault (1).jpg" alt="Body fat and visceral fat comparison illustration" style="display: block; width: 100%; aspect-ratio: 16 / 9; object-fit: cover; object-position: center;">
          <div style="padding: 15px 16px 17px;">
...
function polishHero(html) {
  return html
    ...
    .replace(
      ...
      'max-width: 1080px; margin: 0 auto; padding: 24px 22px 18px; text-align: center;'
    )
    .replace(
      'font-size: 46px; line-height: 0.98; letter-spacing: 0.5px; margin: 20px 0 0;',
      'font-size: 48px; line-height: 0.94; letter-spacing: 0.5px; margin: 14px 0 0;'
    )
    .replace(
    ...
    .replace(
      ...
      'font-size: 18px; line-height: 1.42; color: rgba(244,240,232,0.82); margin: 14px auto 0; max-width: 720px; font-weight: 500;'
    )
    .replace(
      '<div style="margin: 22px auto 0; width: 100%;">',
      '<div style="margin: 12px auto 0; width: min(100%, 920px);">'
    )
    .replace(
      'display: block; max-width: 560px; margin: 26px auto 0; text-decoration: none;',
      'display: block; max-width: 560px; margin: 14px auto 0; text-decoration: none;'
    )
    .replace(
